...
batch_size = 256
r['cnn3_balanced_ss'] = keras_utils.cv_rnn(data, target, groups, models.cnn3adam_filter,
                                name='balanced', epochs=50, folds=5, batch_size=batch_size, 
                                counter=counter, plot=True, stop_after=15, balanced=True, cropsize=2700)
