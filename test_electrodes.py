...
#result['feat_all_balanced'] = keras_utils.cv(np.hstack([feats_eeg,feats_eog,feats_emg]), target, groups, models.ann, balanced=True, name = 'all', stop_after=25) 
#
...
pickle.dump(r, open('results_balanced.pkl', 'wb'))
